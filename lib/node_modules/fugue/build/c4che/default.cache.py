...
CPPPATH_NODE = '/usr/local/Cellar/node/0.4.8/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
LIBDIR = '/usr/local/lib/node_modules:/Users/Paul/local/node/lib/node_modules:'
LIBPATH_NODE = '/usr/local/Cellar/node/0.4.8/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/usr/local/lib/node_modules:/Users/Paul/local/node/lib/node_modules:'
PREFIX = '/usr/local'
PREFIX_NODE = '/usr/local/Cellar/node/0.4.8'
